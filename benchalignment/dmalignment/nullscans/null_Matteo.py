...
# All non-injected segments are parked here while scanning the baseline nulls.
# Use the value that reliably sends unused segments away from the injection region.
PARKED_OTHER_SEGMENT_TIPTILT = (5, -3)
...
def park_non_injected_segment(dm: Any, segment: int) -> None:
    tip, tilt = PARKED_OTHER_SEGMENT_TIPTILT
    set_segment(dm, segment, 0.0, tip, tilt)
...
if __name__ == "__main__":
    ...
    print(f"Parked non-injected tip/tilt: {PARKED_OTHER_SEGMENT_TIPTILT}")
    ...
    try:
        ...
        metadata = {
            "comments": [
                ...
                f"Parked non-injected tip/tilt: {PARKED_OTHER_SEGMENT_TIPTILT}",
        ...
        save_json(solution_json, {
            ...
            "parameters": {
                ...
                "PARKED_OTHER_SEGMENT_TIPTILT": PARKED_OTHER_SEGMENT_TIPTILT,
                "BASELINES": BASELINES,
