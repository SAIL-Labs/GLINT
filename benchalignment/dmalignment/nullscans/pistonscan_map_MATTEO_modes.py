...
#   PARK_OTHER_SEGMENTS = "tilted"  -> parked segments use OTHER_SEGMENT_TIPTILT
PARK_OTHER_SEGMENTS = "tilted"      # "flat" or "tilted"
OTHER_SEGMENT_TIPTILT = (-3, 4)     # used only when PARK_OTHER_SEGMENTS="tilted"
...
if __name__ == "__main__":
    ...
    print(f"Parking mode for non-optimised segments: {PARK_OTHER_SEGMENTS}, tip/tilt={get_park_tiptilt()}")
    ...
    comments = [
        ...
        f"Non-optimised segments parked with mode {PARK_OTHER_SEGMENTS}, tip/tilt={get_park_tiptilt()}.",
