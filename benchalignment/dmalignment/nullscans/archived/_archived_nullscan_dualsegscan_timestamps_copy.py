...
def nullscan(dm, baseline: np.ndarray, tip: np.ndarray, tilt: np.ndarray, pistpositions, box, dark, scan_one_segment=False, tilt_unused=True, save_timestamps=False) -> None:
   ...
   # Get the dark frame
    ...
    for baseline in [["11","31"], ["11","20"], ["20","31"]]:
        ...
        for num in range(numavg):
            ...
            movie, scan, opd, timestamps = nullscan(dm, baseline, tip, tilt, pistpositions, box, dark, scan_one_segment=scan_one_segment, tilt_unused=tilt_unused, save_timestamps=save_timestamps)
