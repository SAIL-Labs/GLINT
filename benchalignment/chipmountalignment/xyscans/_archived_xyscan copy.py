...
def savedata(path, photometry_scans, select_axes, iteration):
    """
    ...
    for i, photometry in enumerate(photometry_scans):
        ...
        hdul.writeto(f'{path}/{axlabel1}{axlabel2}scan_spectra{i+1}_{iteration}.fits', overwrite=True)
...
if __name__ == "__main__":
    ...
    savepath = str(glint_paths.data_dir('alignment_scans', 'xyscans', '2025', date, f'scan{iteration}'))
    ...
    # Save the scan data
    savedata(savepath, photometry_scans, select_axes, iteration)
