...
path = '/mnt/userdata/srossini/nullscans/2025/10-27/scan1/movie_11:20.fits'
...
peaks, _ = find_peaks(summed_data, height=12500, distance=10)
# Plotting the peaks
...
ani.save('phot20_scanning11:20.mp4', writer='ffmpeg', fps=20)
